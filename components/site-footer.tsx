...
export function SiteFooter() {
	return (
		<footer className="mt-6 flex min-h-14 w-full flex-col items-center justify-center gap-2 border-t border-border/40 p-4 sm:flex-row sm:justify-between sm:gap-0">
